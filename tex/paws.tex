...
En \paw y \daad los nombres por debajo de 50 se consideran nombre propios, y el jugador no se puede referir a ellos con un pronombre ("IT" en la versión inglesa, o cualquier verbo terminado en -LA,-LO,-LAS,-LOS en la española).
...
Contienen el nombre y adjetivo (respectivamente) al que se puede referir el jugador con un pronombre (generalmente "IT" en la versión inglesa; en la versión española se acepta una terminación -LA/-LO/-LAS/-LOS).
